  ...
  theme: {
    extend: {
      colors: {
        ...
        primary_web: 'hsl(var(--primary-web))',
        primary_web_dark: 'hsl(var(--primary-web--dark))',
        secondary_web: 'hsl(var(--secondary-web))',
        secondary_web_dark: 'hsl(var(--secondary-web--dark))',
        card: {
