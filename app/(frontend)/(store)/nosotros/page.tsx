  ...
  return (
    <section className="bg-transparent overflow-hidden">
      <div className="relative w-full h-[350px] lg:h-screen 2xl:h-[60vh] mt-[84px] lg:mt-[160px]">
        <img
          src={
            "https://dev24.kodesolution.com/transplix/wp-content/uploads/2024/02/3.jpg"
          }
          alt="Banner 1"
      ...
      <div className="w-full pt-10 lg:pb-20 lg:pt-0 px-4 lg:px-10  max-w-[1570px] mx-auto  bg-white z-[20] mt-10">
        <div
          className="w-full lg:h-[600px] flex flex-col items-center lg:flex-row justify-between gap-10 lg:gap-14"
          id="empresa"
        >
          <AnimationLeft className="flex flex-col w-full lg:w-[50%] flex-1">
            ...
            <h2 className="text-black font-roundkeyMedium text-4xl uppercase lg:text-7xl mt-4 lg:mt-8">
              {'"AR Logistics Group S.A.C Internacional Logistic"'}
            </h2>
            <p className="text-black/80 font-proximaRegular text-base text-justify lg:text-start 2xl:text-lg w-full mt-10">
              Somos una empresa dedicada al transporte internacional, formada
              por una corporación con mas de 15 años de experiencia en el
              comercio exterior, nuestro staff de colaboradores esta conformada
              por 58 profesionales con experiencia en el rubro, quienes
              permitirán que sus actividades comerciales internacionales se
              desarrollan de una forma mas rápida, segura, económica y confiable
              que usted y su digna representada se merecen.
            </p>
            <button className="mt-6 bg-primary hover:bg-secondary transition-colors rounded-md px-6 py-2 w-fit text-white font-proximaSemibold text-lg">
              Contactarnos
            </button>
          </AnimationLeft>
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-3 px-0 lg:px-20 gap-3 lg:gap-10">
              ...
              <div className="w-full p-4 border shadow-md shadow-black/20 flex flex-col items-center gap-2 rounded-md mt-4">
                ...
                <div className="w-full flex flex-col justify-center">
                  ...
                  <span className="block w-40 my-2 h-[6px] mx-auto bg-main border-md"></span>
                  <p className="text-black/80 gap-3 font-proximaRegular text-center text-lg flex  h-36 items-center">
                    Contamos con un equipo altamente capacitado, con experiencia
                    y habilidades específicas para satisfacer las necesidades de
                    nuestros clientes.
                  </p>
                </div>
              </div>
              <div className="w-full p-4 border shadow-md shadow-black/20 flex flex-col items-center gap-2 rounded-md mt-4">
                ...
                <div className="w-full flex flex-col justify-center">
                  ...
                  <span className="block w-40 my-2 h-[6px] mx-auto bg-main border-md"></span>
                  <p className="text-black/80 gap-3 font-proximaRegular text-center text-lg flex  h-36 items-center">
                    Nuestro compromiso es mantener un flujo de información claro
                    y constante, asegurando que cada consulta o solicitud sea
