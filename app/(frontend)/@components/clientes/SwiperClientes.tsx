    ...
    <div className="w-full mt-0 relative lg:px-20">
      ...
      >
        <SwiperSlide className="relative flex items-center justify-center group">
          <img
            src="/assets/clientes/cliente1.png"
            alt="Banner 1"
        ...
        <SwiperSlide className="relative flex items-center justify-center group">
          <img
            src="/assets/clientes/cliente2.png"
            alt="Banner 1"
            className="p-2 w-96 h-24 m-auto object-contain block grayscale group-hover:grayscale-0 transition-none"
          />
        </SwiperSlide>
        <SwiperSlide className="relative flex items-center justify-center group">
          <img
            src="/assets/clientes/cliente3.png"
            alt="Banner 3"
            className="p-2 w-96 h-24 m-auto object-contain block grayscale group-hover:grayscale-0 transition-none"
          />
        </SwiperSlide>
        <SwiperSlide className="relative flex items-center justify-center group">
          <img
            src="/assets/clientes/cliente4.png"
            alt="Banner 4"
            className="p-2 w-96 h-24 m-auto object-contain block grayscale group-hover:grayscale-0 transition-none"
          />
        </SwiperSlide>
        <SwiperSlide className="relative flex items-center justify-center group">
          <img
            src="/assets/clientes/cliente5.png"
            alt="Banner 6"
            className="p-2 w-96 h-24 m-auto object-contain block grayscale group-hover:grayscale-0 transition-none"
          />
        </SwiperSlide>
