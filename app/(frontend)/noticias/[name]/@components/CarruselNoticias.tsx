          ...
          <SwiperSlide className="" key={product.id}>
            ...
            >
              <div className="relative h-48 lg:h-64  transition-all overflow-hidden ">
                ...
                <img className="w-full h-full object-cover object-center group-hover:scale-105 transition-all" src={`${process.env.NEXT_PUBLIC_BASE_URL}/api/uploads/blogs/${product.imagen1}`} alt="Edificio" />
              </div>
              <div className="p-4">
                <h3 className="text-lg font-montserratBold line-clamp-1 text-black">{product.titulo}</h3>
