...
export async function POST (req: NextRequest) {
  ...
  try {
    ...
    const uploadDir = path.join(process.cwd(), 'private/uploads', 'servicios') // Carpeta privada
    ...
    await ServiciosModel.create({ titulo, url, imagen1: formattedName1, resumen, descripcion, created_at: new Date(), updated_at: new Date() })
