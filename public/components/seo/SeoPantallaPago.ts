export function SeoPantallaPago () {
  return {
    title: 'Pantalla de pago | Envío de flores y regalos a domicilio | My Lady | Florerías Lima | Detalles para enviar',
    description: 'Pantalla de pago | https://floreriamylady.com/checkout | Envía flores y desayunos sorpresa a la persona que tienes en el corazón | Flores y regalos inolvidables. Caja de Rosas y tulipanes, desayunos sorpresa, peluches!',
    keywords:
    ...
    openGraph: {
      type: 'website',
      locale: 'es_PE',
      url: 'https://floreriamylady.com/checkout',
      title: 'Pantalla de pago | Envío de flores y regalos a domicilio | My Lady | Florerías Lima | Detalles para enviar',
      description: 'Pantalla de pago | https://floreriamylady.com/checkout | Envía flores y desayunos sorpresa a la persona que tienes en el corazón | Flores y regalos inolvidables. Caja de Rosas y tulipanes, desayunos sorpresa, peluches!',
      images: [
        {
    ...
    alternates: {
      canonical: 'https://floreriamylady.com/checkout'
    }
  }
}
