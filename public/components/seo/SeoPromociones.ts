...
export function SeoPromociones () {
  return {
    title: 'Promociones | Envío de flores y regalos a domicilio | My Lady | Florerías Lima | Detalles para enviar',
    description: 'Promociones | https://floreriamylady.com/promociones | Envía flores y desayunos sorpresa a la persona que tienes en el corazón | Flores y regalos inolvidables. Caja de Rosas y tulipanes, desayunos sorpresa, peluches!',
    keywords:
    ...
    openGraph: {
      type: 'website',
      locale: 'es_PE',
      url: 'https://floreriamylady.com/promociones',
      title: 'Promociones | Envío de flores y regalos a domicilio | My Lady | Florerías Lima | Detalles para enviar',
      description: 'Promociones | https://floreriamylady.com/promociones | Envía flores y desayunos sorpresa a la persona que tienes en el corazón | Flores y regalos inolvidables. Caja de Rosas y tulipanes, desayunos sorpresa, peluches!',
      images: [
        {
    ...
    alternates: {
      canonical: 'https://floreriamylady.com/promociones'
    }
  }
}
