export function SuccesPaySeo () {
  return {
    title:
      'Pago exitoso | Envío de flores y regalos a domicilio | My Lady | Florerías Lima | Detalles para enviar',
    description:
      'Pago exitoso | Envía flores y desayunos sorpresa a la persona que tienes en el corazón | Flores y regalos inolvidables. Caja de Rosas y tulipanes, desayunos sorpresa, peluches!',
    keywords:
    ...
    alternates: {
      canonical: 'https://floreriamylady.com'
    }
  }
}
